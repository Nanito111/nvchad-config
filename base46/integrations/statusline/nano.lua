...
local M = {
  StatusLine = { bg = "none" },
  St_gitIcons = { fg = light_grey, bg = "none" },
...
local function genModes_hl(modename, col)
  ...
  M["St_" .. modename .. "ModeSep"] = { fg = colors[col], bg = colors.none }
  M["St_" .. modename .. "modeText"] = { fg = colors.black, bg = colors[col] }
end
...
local function gen_hl(name, col)
  ...
  M["St_" .. name .. "_txt"] = { fg = colors.black, bg = colors[col] }
  M["St_" .. name .. "_sep"] = { fg = colors[col], bg = colors.none }
end
